                    ...
                    <div class="login-box">
                        ...
                        <form action="register" method="POST">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="name" name="name" class="formfield" placeholder="name">
                                @error('name')
                            ...
                            <div class="input-group">
                                ...
                                <input type="email" id="email" name="email" class="formfield" placeholder="Email Address">
                                @error('email')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="input-group">
                                ...
                                <input type="password" id="password" name="password" class="formfield" placeholder="Password">
                                @error('password')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="input-group">
                                ...
                                <input type="password" id="password" name="password_confirmation" class="formfield" placeholder="Confirm Password">
