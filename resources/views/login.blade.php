            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    <div class="login-box">
                        ...
                        <div class="options">
                            <p><a href="{{url('forgot-password')}}">Forget password?</a></p>
                        </div>
                        <form action="login" method="POST">
                            @csrf
                            <div class="input-group">
                                <label for="email"><i class="fas fa-envelope"></i></label>
                                <input type="email" id="email" name="email" class="formfield"
                        ...
                        <div class="d-flex justify-content-between align-items-center login-options-inner">
                            <div class="redirect-btns">
                                <a href="{{route('google.login')}}" class="loginbtn"><svg version="1.1"
