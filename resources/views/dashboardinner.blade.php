    ...
    <div class="container-fluid">
        <div class="row" style="height: calc(100vh - 70px);">
            ...
            <div class="col-7 main-content" id="mainContent">
                <div id="dga" class="content-block">Line Producer: Winnie Bong<br>Unit Production Manager: Hanh
                    Keon</div>
                <div id="cast" class="content-block" style="display:none">Jiyoung Yoo, Jung Joon Ho, Jessica Hwang,
                    etc.</div>
                <div id="stunts" class="content-block" style="display:none">Stunt Coordinator: Samantha
                    Gao<br>Choreographer: Andrew Freeman</div>
                <div id="camera" class="content-block" style="display:none">Camera Operators, Focus Pullers, etc.
                </div>
            </div>
